...
<div class="col-md-12 text-center"><h4><b>Last Ten Transactions</b></h4></div>
...
<%
String acno=request.getParameter("acno");//(String)session.getAttribute("custid");
AccountDAO acdao = new AccountDAO();
List<Transaction> tranlist = acdao.viewTransactions(acno);
